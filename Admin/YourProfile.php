...
class YourProfile extends Page
{
	public function __construct()
	{
		...
		require_once(Application::$RootDirectory."/FileUpload/Core/UploadHandler.php");
		parent::__construct();
		$this->ProfileID = Application::$CurrentProfile->ID;
		$this->Profile = Application::$CurrentProfile;
		$this->RegisterResource( 'ProfileAdmin.css', "stylesheet", Server::MapPath('~/Admin/Theme/ProfileAdmin.css'), null, "before");
		//$ul = new UploadHandler();
		//$rslt = $ul->get();
		//echo $rslt;
	}
	...
	protected function CreateControls()
	{
		...
		{
			echo " Null Profile (YourProfile.php->CreateControls) ";
			return;
		}
	...
	private function LoadProfile()
	{
		...
		{
			echo " Null ProfileID (YourProfile.php->LoadProfile) ";
			return;
		}
