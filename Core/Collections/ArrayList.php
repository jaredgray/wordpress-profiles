...
class ArrayList implements ICloneable, IList {
	 ...
	 * @access public
	 * @param object $value The System.Object to locate. The value can be null.
	 * @param int $index The zero-based starting index of the range to search.
	 * @param int $count The length of the range to search.
	 ...
	 * @return void
	 */
	public function copyTo(&$array, $index=0) {
	 ...
	 * @access public
	 * @throws ArgumentNullException|ArgumentOutOfRangeException|NotSupportException
	 ...
	 * @access public
	 * @throws ArgumentOutOfRangeException|ArgumentException|NotSupportedException
	 ...
	 * @access public
	 * @throws NotSupportedException
	 * @param object $comparer The System.Collections.IComparer implementation to use when comparing elements. -or-  null to use the System.IComparable implementation of each element.
	 * @return void
	 */
	public function sort($comparer=null) {
		if($this->isReadOnly()) throw new NotSupportedException("The System.Collections.ArrayList is read-only.");
		if($comparer instanceof \System\IComparer) {
	...
	private function sortWithComparable(\System\IComparer $comparer) {
